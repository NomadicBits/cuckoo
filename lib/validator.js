...
var validate = exports.validate = function () {
  var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(values, context) {
    ...
    var schema, result, breakEarly, shouldWhitelist, properties, schemaProperties, whitelist, disallowed, i, property, validators, j, validator, value, _result, template;
