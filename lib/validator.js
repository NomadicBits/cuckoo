...
var validate = exports.validate = function () {
  var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(values, context) {
    ...
    var schema, result, breakEarly, shouldWhitelist, properties, whitelist, disallowed, i, property, validators, j, validator, value, _result;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 17:
            ...
            if (_lodash2.default.has(schema, property)) {
              _context.next = 21;
              break;
            }
          ...
          case 33:
            ...
            result.hasErrors = true;
            result.errors[property][validator.name] = _context.t0;
